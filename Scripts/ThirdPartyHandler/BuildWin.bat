...
echo "Creating builds of libraries..."
...
devenv %PROJECT_SDL_PATH% /Build %CONFIGURATION%|%ARCHITECTURE%
devenv %PROJECT_SDL_IMAGE_PATH% /Build %CONFIGURATION%|%ARCHITECTURE%
devenv %PROJECT_SDL_Mixer_PATH% /Build %CONFIGURATION%|%ARCHITECTURE%
devenv %PROJECT_SDL_TTF_PATH% /Build %CONFIGURATION%|%ARCHITECTURE%

echo "Creating builds of libraries finished."
